from superwx4.ui.base import BaseUISubWnd, BaseUIWnd
from superwx4.ui import WeChatMainWnd, WeChatSubWnd
from superwx4.logger import wxlog
from superwx4.param import WxParam, WxResponse, PROJECT_NAME
from superwx4.utils import GetAllWindows, uilock
from superwx4.utils.tools import delete_update_files
...
if TYPE_CHECKING:
    from superwx4.msgs.base import Message
    from superwx4.ui.sessionbox import SessionElement
...
class WeChat(Chat, Listener):
    ...
    def KeepRunning(self):
        ...
        while not self._listener_stop_event.is_set():
            try:
                ...
                wxlog.debug(f'superwx4("{self.nickname}") shutdown')
    ...
    def Moments(self, timeout: int = 3, *, dry_run: bool = True, allow_foreground: bool = False) -> WxResponse:
        ...
        from superwx4.moment import Moment, MomentsWnd
        try:
            moment = Moment(self)
    ...
    def GetFriendList(
        ...
        from superwx4.ui.contactbox import ContactBox
        try:
