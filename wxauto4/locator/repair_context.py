...
Usage::
    ...
    from wxauto4.locator.repair_context import generate_repair_context
    path = generate_repair_context(failed_controls, dump_dir=".wxauto4_repair/dumps")
"""
...
def generate_repair_context(
    ...
    dump_dir: str = ".wxauto4_repair/dumps",
    output_dir: str = ".wxauto4_repair/reports",
) -> str:
    ...
    lines: List[str] = []
    lines.append("# wxauto4 Repair Context")
    lines.append("")
    ...
    lines.append("")
    lines.append("1. **优先修改 `wxauto4/locator/selectors.py`** — 只改 selector，不改业务逻辑。")
    ...
    lines.append("")
    lines.append("- `wxauto4/locator/selectors.py`")
    lines.append("- `wxauto4/locator/engine.py`")
    lines.append("- `wxauto4/ui/chatbox.py`")
    lines.append("- `wxauto4/ui/main.py`")
    lines.append("- `wxauto4/ui/sessionbox.py`")
    lines.append("- `tests/`")
    lines.append("")
    ...
    lines.append("")
    lines.append("- `wxauto4/utils/useful.py` (auth/license)")
    ...
    lines.append("1. Updates `wxauto4/locator/selectors.py` with new/modified selectors.")
